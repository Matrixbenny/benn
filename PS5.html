...
<head>
        ...
        <title style="font-style: unset; text-decoration: blue;">BENNTORRENT/PS5 GAMES🎥</title>
</head>
...
<body>
        <div>
                ...
                <p>
                        <img src="images/ps5.png" <br>
                <h1 style="text-decoration: underline; width: fit-content;">PS5 Games</h1>
                </p>
                <style>
                        .image-grid {
                                display: grid;
