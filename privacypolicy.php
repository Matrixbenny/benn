    ...
    <div>
        <header>
            <details>
                ...
                <br>
        </header><a href="index.html" style="font-size: 200%;"> 🔙</a>
        <h1>Privacy Policy</h1>
        <p>This privacy policy sets out how [Your Company Name] uses and protects any information that you give [Your
            Company Name] when you use this website.</p>
        <p>[Your Company Name] is committed to ensuring that your privacy is protected. Should we ask you to provide
            certain
            information by which you can be identified when using this website, then you can be assured that it will
            only be
            used in accordance with this privacy statement.</p>
        <p>[Your Company Name] may change this policy from time to time by updating this page. You should check this
            page
            from time to time to ensure that you are happy with any changes. This policy is effective from [date].</p>
        ...
        <p>We use traffic log cookies to identify which pages are being used. This helps us analyse data about web page
        ...
        <ul>
            ...
            <li>ifyou have previously agreed to us using your personal information for direct marketing purposes, you
                may
